...
var I18N = {
  ...
  "Spectating by default — join a team to play (that's your ready!). Then give the 🔑 to one Ninja per team. The host can move anyone or shuffle it all.": { fr: "Spectateur par défaut — rejoins une équipe pour jouer (c'est ton prêt !). Puis donne la 🔑 à un Ninja par équipe. L'hôte peut déplacer n'importe qui ou tout mélanger.", es: "Espectador por defecto — únete a un equipo para jugar (¡ese es tu listo!). Luego da la 🔑 a un Ninja por equipo. El anfitrión puede mover a cualquiera o mezclarlo todo." },
