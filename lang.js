...
var I18N = {
  ...
  "Only the spymaster can give the clue!": { fr: "Seul le maître-espion peut donner l'indice !", es: "¡Solo el maestro espía puede dar la pista!" },
  ...
  "The spymaster watches — teammates pick the cards!": { fr: "Le maître-espion regarde — les coéquipiers choisissent les cartes !", es: "¡El maestro espía observa — los compañeros eligen las cartas!" },
  ...
  "🕵️ spymaster:": { fr: "🕵️ maître-espion :", es: "🕵️ maestro espía:" },
  "Nobody here yet…": { fr: "Personne ici pour l'instant…", es: "Nadie aquí todavía…" },
  "SPYMASTER": { fr: "MAÎTRE-ESPION", es: "MAESTRO ESPÍA" },
  "Make spymaster": { fr: "Nommer maître-espion", es: "Nombrar maestro espía" },
  ...
  "you are the 🕵️ SPYMASTER": { fr: "tu es le 🕵️ MAÎTRE-ESPION", es: "eres el 🕵️ MAESTRO ESPÍA" },
  ...
  "Waiting for YOUR spymaster to give the clue…": { fr: "En attente de TON maître-espion pour l'indice…", es: "Esperando a que TU maestro espía dé la pista…" },
  "Waiting for the other team's clue…": { fr: "En attente de l'indice de l'autre équipe…", es: "Esperando la pista del otro equipo…" },
  "Your team is picking — spymaster, stay silent! 🤫": { fr: "Ton équipe choisit — maître-espion, silence ! 🤫", es: "Tu equipo está eligiendo — maestro espía, silencio 🤫" },
  ...
  "You are a FIELD AGENT — wait for the clue…": { fr: "Vous êtes un AGENT DE TERRAIN — attendez l'indice…", es: "Eres un AGENTE DE CAMPO — espera la pista…" },
  "SPYMASTER key — only you see every color": { fr: "Clé de l'ESPION-CHEF — seul vous voyez les couleurs", es: "Clave del ESPÍA-JEFE — solo tú ves los colores" },
  ...
  "Tapped cards reveal RED for everyone at the table.": { fr: "Les cartes touchées révèlent ROUGE pour toute la table.", es: "Las cartas tocadas revelan ROJO para toda la mesa." },
