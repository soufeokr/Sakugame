...
var I18N = {
  ...
  // ===== 🗝 CODE NAMES =====
  "Ninja Scrolls needs at least 4 players (2+ per team)!": { fr: "Ninja Scrolls demande au moins 4 joueurs (2+ par équipe) !", es: "¡Ninja Scrolls necesita al menos 4 jugadores (2+ por equipo)!" },
  ...
  "Ninja Scrolls needs at least 4 players in teams (2+ per team)!": { fr: "Ninja Scrolls demande au moins 4 joueurs dans les équipes (2+ par équipe) !", es: "¡Ninja Scrolls necesita al menos 4 jugadores en equipos (2+ por equipo)!" },
  "(others spectate 👀)": { fr: "(les autres spectatent 👀)", es: "(los demás miran 👀)" },
  "All seats are taken — keep spectating until a seat frees up!": { fr: "Toutes les places sont prises — continuez d'observer jusqu'à ce qu'une place se libère !", es: "¡Todos los asientos están ocupados — sigue observando hasta que se libere uno!" },
  ...
  "Each team needs a Ninja — drag a name tag into a NINJA spot!": { fr: "Chaque équipe a besoin d'un Ninja — glisse un pseudo dans une place NINJA !", es: "¡Cada equipo necesita un Ninja — arrastra un nombre a un puesto NINJA!" },
  "That 🔑 is taken!": { fr: "Cette 🔑 est prise !", es: "¡Esa 🔑 está ocupada!" },
  "Drag me to a box!": { fr: "Glisse-moi dans une case !", es: "¡Arrástrame a una casilla!" },
  ...
  "…was one of the OPPONENTS' cards! Turn over": { fr: "…était une carte ADVERSE ! Tour terminé", es: "…¡era una carta del RIVAL! Turno terminado" },
  "The Ninja watches — teammates suggest the cards!": { fr: "Le Ninja observe — les coéquipiers suggèrent les cartes !", es: "¡El Ninja observa — los compañeros sugieren las cartas!" },
  "Pick this card!": { fr: "Valide cette carte !", es: "¡Elige esta carta!" },
  "Pick this card?": { fr: "Choisir cette carte ?", es: "¿Elegir esta carta?" },
  "Lock in": { fr: "Valider", es: "Fijar" },
  "A wrong color ends the turn — and 🖤 the assassin loses the game instantly!": { fr: "Une mauvaise couleur termine le tour — et 🖤 l'assassin fait perdre instantanément !", es: "¡Un color equivocado termina el turno — y 🖤 el asesino hace perder al instante!" },
  "Pick it!": { fr: "On y va !", es: "¡Dale!" },
  "passes — next team!": { fr: "passe — équipe suivante !", es: "pasa — ¡siguiente equipo!" },
  "wins — the other team left!": { fr: "gagne — l'autre équipe est partie !", es: "gana — ¡el otro equipo se fue!" },
  "(none yet)": { fr: "(personne)", es: "(nadie)" },
  "RED team": { fr: "Équipe ROUGE", es: "Equipo ROJO" },
  "BLUE team": { fr: "Équipe BLEUE", es: "Equipo AZUL" },
  " player(s)": { fr: " joueur(s)", es: " jugador(es)" },
  "🕵️ Ninja": { fr: "🕵️ Ninja", es: "🕵️ Ninja" },
  "Nobody here yet…": { fr: "Personne ici pour l'instant…", es: "Nadie aquí todavía…" },
  "NINJA": { fr: "NINJA", es: "NINJA" },
  "Shogun": { fr: "Shogun", es: "Shogun" },
  "Demote to Shoguns": { fr: "Rétrograder en Shoguns", es: "Degradar a Shoguns" },
  "Make Ninja": { fr: "Nommer Ninja", es: "Nombrar Ninja" },
  "Move to the other team": { fr: "Changer d'équipe", es: "Mover al otro equipo" },
  "To the bench": { fr: "Sur le banc", es: "Al banquillo" },
  "Put in team": { fr: "Mettre dans l'équipe", es: "Poner en el equipo" },
  "Join": { fr: "Rejoindre", es: "Unirse" },
  "Leave": { fr: "Quitter", es: "Salir" },
  "Hide": { fr: "Cacher", es: "Ocultar" },
  "Show": { fr: "Afficher", es: "Mostrar" },
  "Your team": { fr: "Ton équipe", es: "Tu equipo" },
  "you are the 🕵️ NINJA": { fr: "tu es le 🕵️ NINJA", es: "eres el 🕵️ NINJA" },
  "Spectating — pick a team next round!": { fr: "En spectateur — choisis une équipe à la prochaine manche !", es: "Espectando — ¡elige un equipo en la próxima ronda!" },
  "Your turn — give a clue!": { fr: "À toi — donne un indice !", es: "¡Tu turno — da una pista!" },
  "⏳ clue time —": { fr: "⏳ heure de l'indice —", es: "⏳ hora de la pista —" },
  "is thinking…": { fr: "réfléchit…", es: "está pensando…" },
  "pick phase —": { fr: "phase de choix —", es: "fase de elección —" },
  "card(s) left to pick": { fr: "carte(s) restante(s)", es: "carta(s) por elegir" },
  "card left to pick": { fr: "carte restante", es: "carta restante" },
  "CLUE": { fr: "INDICE", es: "PISTA" },
  "no clue yet…": { fr: "pas encore d'indice…", es: "aún no hay pista…" },
  "Waiting for YOUR Ninja to give the clue…": { fr: "En attente de TON Ninja pour l'indice…", es: "Esperando a que TU Ninja dé la pista…" },
  "Waiting for the other team's clue…": { fr: "En attente de l'indice de l'autre équipe…", es: "Esperando la pista del otro equipo…" },
  "Your team is picking — Ninja, stay silent! 🤫": { fr: "Ton équipe choisit — Ninja, silence ! 🤫", es: "Tu equipo está eligiendo — Ninja, silencio 🤫" },
  "The other team is picking…": { fr: "L'autre équipe choisit…", es: "El otro equipo está eligiendo…" },
  "RED": { fr: "ROUGE", es: "ROJO" },
  "BLUE": { fr: "BLEU", es: "AZUL" },
  "team wins!": { fr: "remporte la partie !", es: "¡equipo ganador!" },
  "Ninja Scrolls over": { fr: "Ninja Scrolls terminé", es: "Ninja Scrolls terminado" },
  ...
  "All your agents found — brilliant spycraft!": { fr: "Tous tes agents trouvés — espionnage magistral !", es: "Todos tus agentes encontrados — ¡espionaje brillante!" },
  "They found all their agents first!": { fr: "Ils ont trouvé tous leurs agents en premier !", es: "¡Encontraron todos sus agentes primero!" },
  "left": { fr: "restant(s)", es: "restante(s)" },
  "cards were revealed": { fr: "cartes ont été révélées", es: "cartas fueron reveladas" },
  ...
  "Username: 3-20 characters, letters, numbers and _ only.": { fr: "Pseudo : 3 à 20 caractères — lettres, chiffres et _ uniquement.", es: "Usuario: 3-20 caracteres: letras, números y _ solamente." },
  "Your room is still open:": { fr: "Ta room est toujours ouverte :", es: "Tu sala sigue abierta:" },
  "clues:": { fr: "indices :", es: "pistas:" },
  "Content filter": { fr: "Filtre de contenu", es: "Filtro de contenido" },
  "Hide NSFW (18+) characters & covers": { fr: "Masquer les personnages et affiches +18", es: "Ocultar personajes y portadas +18" },
  "18+ content hidden.": { fr: "Contenu 18+ masqué.", es: "Contenido 18+ oculto." },
  "18+ content visible.": { fr: "Contenido 18+ visible.", es: "Contenido 18+ visible." },
  "Danger zone": { fr: "Zone dangereuse", es: "Zona de peligro" },
  "Delete my account": { fr: "Supprimer mon compte", es: "Eliminar mi cuenta" },
  "This permanently deletes your account, username, stats and AniList link. This cannot be undone.": { fr: "Cela supprime définitivement ton compte, ton pseudo, tes stats et ton lien AniList. Action irréversible.", es: "Esto elimina permanentemente tu cuenta, usuario, estadísticas y vínculo de AniList. No se puede deshacer." },
  "Type your password to confirm": { fr: "Tape ton mot de passe pour confirmer", es: "Escribe tu contraseña para confirmar" },
  "Delete permanently": { fr: "Supprimer définitivement", es: "Eliminar definitivamente" },
  "Account deleted. Goodbye!": { fr: "Compte supprimé. À bientôt !", es: "Cuenta eliminada. ¡Adiós!" },
  "Please log out and back in, then try again.": { fr: "Déconnecte-toi puis reconnecte-toi, et réessaie.", es: "Cierra sesión, vuelve a entrar e inténtalo de nuevo." },
  ...
  "4-8 players, 2 teams! The Ninja gives a ONE-word clue — tap your agents' cards, dodge the assassin, and find all your agents first!": { fr: "4-8 joueurs, 2 équipes ! Le Ninja donne UN indice en un mot — touche les cartes de tes agents, évite l'assassin et trouve tous tes agents en premier !", es: "¡4-8 jugadores, 2 equipos! El Ninja da UNA pista de una palabra — ¡toca las cartas de tus agentes, esquiva al asesino y encuentra todos tus agentes primero!" },
  "Ninja Scrolls — Team Setup": { fr: "Ninja Scrolls — Composition des équipes", es: "Ninja Scrolls — Formación de equipos" },
  "Spectating by default — join a box (or drag your name tag) to play; joining = ready. One 🔑 Ninja per team — first tap wins. The host can drag anyone into place or shuffle.": { fr: "Spectateur par défaut — rejoins une case (ou glisse ton pseudo) pour jouer ; rejoindre = prêt. Un 🔑 Ninja par équipe — le premier à taper gagne. L'hôte peut déplacer tout le monde ou mélanger.", es: "Espectador por defecto — únete a una casilla (o arrastra tu nombre) para jugar; unirte = listo. Un 🔑 Ninja por equipo — el primero en pulsar gana. El anfitrión puede arrastrar a cualquiera o mezclar." },
  "SHOGUN": { fr: "SHOGUN", es: "SHOGUN" },
  "Queued visitors join by themselves!": { fr: "Les visiteurs en file d'attente rejoignent d'eux-mêmes !", es: "¡Los visitantes en cola se unen por sí mismos!" },
  ...
  "Start — deal the cards!": { fr: "Commencer — distribue les cartes !", es: "¡Empezar — reparte las cartas!" },
  ...
  "Normal": { fr: "Normal", es: "Normal" },
  "Hard": { fr: "Difficile", es: "Difícil" },
  "Extreme": { fr: "Extrême", es: "Extremo" },
  "how popular the picks are — Easy = rank 1-375 · Normal = 376-750 · Hard = 751-1125 · Extreme = 1126-1500": { fr: "la popularité des tirages — Facile = rang 1-375 · Normal = 376-750 · Difficile = 751-1125 · Extrême = 1126-1500", es: "la popularidad de los sorteos — Fácil = rango 1-375 · Normal = 376-750 · Difícil = 751-1125 · Extremo = 1126-1500" },
  "Not enough anime for Snapshot! in this difficulty — try an easier band.": { fr: "Pas assez d'animes pour Snapshot! dans cette difficulté — essaie une bande plus facile.", es: "No hay suficientes animes para Snapshot! en esta dificultad — prueba una banda más fácil." },
  "Snapshot!": { fr: "Snapshot!", es: "Snapshot!" }, // PROTECT (game name — stays in English)
  "Stills": { fr: "Images", es: "Imágenes" },
  "Which anime is this?!": { fr: "C'est quel anime ?!", es: "¡¿Qué anime es este?!" },
  "one more still lands every few seconds…": { fr: "une image de plus arrive toutes les quelques secondes…", es: "llega una imagen más cada pocos segundos…" },
  "next round in": { fr: "manche suivante dans", es: "siguiente ronda en" },
  "Nope! Keep trying — a bigger crop is coming…": { fr: "Non ! Réessaye — un cadrage plus large arrive…", es: "¡No! ¡Sigue! Viene un encuadre mayor…" },
  "nobody — next round!": { fr: "personne — manche suivante !", es: "nadie — ¡siguiente ronda!" },
  "wins Snapshot! with": { fr: "gagne Snapshot! avec", es: "gana Snapshot! con" },
  "starts with": { fr: "commence par", es: "empieza por" },
  "rounds! Guess the anime from its stills — earlier = more points!": { fr: "manches ! Devine l'anime à partir de ses images — plus tôt = plus de points !", es: "¡rondas! Adivina el anime por sus imágenes — ¡antes = más puntos!" },
  "Type the anime title… (any known alias works: SNK, AoT…)": { fr: "Tape le titre de l'anime… (tout alias connu marche : SNK, AoT…)", es: "Escribe el título del anime… (vale cualquier alias conocido: SNK, AoT…)" },
  "(anime stills to guess)": { fr: "(images d'anime à deviner)", es: "(imágenes de anime por adivinar)" },
  "Game Settings - Snapshot!": { fr: "Paramètres du jeu - Snapshot!", es: "Ajustes del juego - Snapshot!" },
  "Not enough pictures for Snapshot! Check the pool settings.": { fr: "Pas assez d'images pour Snapshot! Vérifie les réglages.", es: "¡No hay suficientes imágenes para Snapshot! Revisa los ajustes de la sala." },
  "4 stills from ONE anime join the frame one by one — name the anime as early as you can! Each still is EASIER than the last (the 4th is the official art, WITH a hint). 1st still = 4 pts … last = 1 pt, and the fastest guesses score a +3/+2/+1 speed bonus. Playable SOLO too!": { fr: "4 images tirées d'UN anime rejoignent l'écran une à une — nomme l'anime au plus tôt ! Chaque image est plus FACILE que la précédente (la 4e est l'art officiel, AVEC un indice). 1re image = 4 pts … dernière = 1 pt, et les plus rapides décroche un bonus +3/+2/+1. Jouable en SOLO aussi !", es: "¡4 imágenes de UN anime van apareciendo una a una — di el anime cuanto antes! Cada imagen es MÁS FÁCIL que la anterior (la 4ª es el arte oficial, CON pista). 1ª imagen = 4 pts … última = 1 pt, y las respuestas más rápidas ganan un bonus +3/+2/+1. ¡También en solitario!" },
  "Each round shows up to 4 stills from one anime, harder → easier (the last is the official art, with a hint) — earlier guess = more points. Pool: the website's anime list (episode stills + official art). Applies from the next game.": { fr: "Chaque manche montre jusqu'à 4 images d'un anime, de dure à facile (la dernière est l'art officiel, avec indice) — réponse plus tôt = plus de points. Pool : la liste d'animes du site (images d'épisodes + art officiel). S'applique à partir de la prochaine partie.", es: "Cada ronda muestra hasta 4 imágenes de un anime, de difícil a fácil (la última es el arte oficial, con pista) — respuesta antes = más puntos. Pool: la lista de animes de la web (imágenes de episodios + arte oficial). Se aplica desde la próxima partida." },
  "Snapshot! (solo or up to 8 players)": { fr: "Snapshot! (en solo ou jusqu'à 8 joueurs)", es: "Snapshot! (en solitario o hasta 8 jugadores)" },
  "Solo or up to 8 players! 4 random stills from ONE anime join the frame one by one, each EASIER than the last (the 4th is the official art). Name the anime as early as you can: stage 1 pays 4 pts, and the fastest correct guesses add a +3/+2/+1 speed bonus!": { fr: "En solo ou jusqu'à 8 joueurs ! 4 images tirées d'UN anime rejoignent l'écran une à une, chacune plus FACILE que la précédente (la 4e est l'art officiel). Nomme l'anime au plus tôt : l'étape 1 rapporte 4 pts, et les réponses les plus rapides ajoutent un bonus +3/+2/+1 !", es: "¡En solitario o hasta 8 jugadores! 4 imágenes de UN anime van apareciendo una a una, cada una MÁS FÁCIL que la anterior (la 4ª es el arte oficial). Di el anime cuanto antes: la etapa 1 da 4 pts, y las respuestas más rápidas añaden un bonus +3/+2/+1!" },
  // 📸 tutorial slides
  "Name that anime!": { fr: "Devine l'anime !", es: "¡Adivina el anime!" },
  "Play solo to train, or race up to 8 players at once! Every round, up to 4 stills from ONE anime (out of 700+ shows) join the frame one by one — first one to type the right title banks the points!": { fr: "Joue en solo pour t'entraîner ou affronte jusqu'à 8 joueurs en direct ! Chaque manche, jusqu'à 4 images tirées d'UN anime (parmi 700+) rejoignent l'écran une à une — le premier qui tape le bon titre empoche les points !", es: "¡Juega en solitario para entrenar o compite contra hasta 8 jugadores a la vez! En cada ronda, hasta 4 imágenes de UN anime (de más de 700 series) van apareciendo una a una — ¡quien escribe el título correcto primero se lleva los puntos!" },
  "Four stills, four payouts": { fr: "Quatre images, quatre gains", es: "Cuatro imágenes, cuatro premios" },
  "Stage 1 shows ONE deep-cut still (brutal!)… then three easier ones at 8-second beats, ending with the official art AND a hint. Payout melts as it gets easy: stage 1 = 4 pts, stage 4 = 1 pt. Trust your gut early!": { fr: "L'étape 1 montre UNE image bien recherchée (brutal !)… puis trois images plus faciles toutes les 8 secondes, finissant par l'art officiel ET un indice. Le gain fond à mesure que ça devient facile : étape 1 = 4 pts, étape 4 = 1 pt. Fais confiance à ton instinct !", es: "La etapa 1 muestra UNA imagen bien rebuscada (¡brutal!)… luego tres imágenes más fáciles cada 8 segundos, acabando con el arte oficial Y una pista. El premio se funde a medida que se vuelve fácil: etapa 1 = 4 pts, etapa 4 = 1 pt. ¡Fíate de tu instinto!" },
  "Stuck? Wait for the hint": { fr: "Coincé ? Attends l'indice", es: "¿Atascado? Espera la pista" },
  "The 4th still lands with genres (max 3), the year, and the title's first letter with its letter count. Any known alias works as an answer — SNK, AoT, the full romaji… (typing the second word alone, like \"Titan\", does NOT count!)": { fr: "La 4e image arrive avec les genres (3 max), l'année et la première lettre du titre avec son nombre de lettres. Tout alias connu marche — SNK, AoT, le romaji entier… (taper juste le 2e mot, comme « Titan », ne compte PAS !)", es: "La 4ª imagen llega con géneros (máx. 3), el año y la primera letra del título con su número de letras. Vale cualquier alias conocido — SNK, AoT, el romaji completo… (¡escribir solo la segunda palabra, como «Titan», NO cuenta!)" },
  "Fast fingers win big": { fr: "Les doigts rapides gagnent gros", es: "Los dedos rápidos ganan en grande" },
  "The FIRST correct guess in a round adds a +3 speed bonus (then +2 and +1). A stage-1 first guess is the jackpot: 4 + 3 = 7 points! The host picks 4-20 rounds — most points at the end wins.": { fr: "La PREMIÈRE bonne réponse d'une manche ajoute un bonus de vitesse +3 (puis +2 et +1). Le premier coup à l'étape 1, c'est le jackpot : 4 + 3 = 7 points ! L'hôte choisit 4-20 manches — le plus gros score gagne.", es: "La PRIMERA respuesta correcta de la ronda añade un bonus de velocidad +3 (luego +2 y +1). ¡El primer acierto en etapa 1 es el bote: 4 + 3 = 7 puntos! El anfitrión elige 4-20 rondas — gana quien más puntos acumule." },
  ...
  "Detective Showdown (2 players)": { fr: "Detective Showdown (2 joueurs)", es: "Detective Showdown (2 jugadores)" },
  "Detective Showdown is a head-to-head duel —": { fr: "Detective Showdown est un duel en tête-à-tête —", es: "Detective Showdown es un duelo cara a cara —" },
  ...
  "Game Settings - Detective Showdown": { fr: "Paramètres du jeu - Detective Showdown", es: "Ajustes del juego - Detective Showdown" },
  ...
  "Detective Royale (3-8 players)": { fr: "Detective Royale (3-8 joueurs)", es: "Detective Royale (3-8 jugadores)" },
  "Wanted! (3-8 players)": { fr: "Wanted! (3-8 joueurs)", es: "Wanted! (3-8 jugadores)" },
  ...
  "One question per turn — wait for the answer first.": { fr: "Une question par tour — attendez la réponse d'abord.", es: "Una pregunta por turno — espera primero la respuesta." },
  ...
  "Play solo to train, or with up to 8 players. Two modes: blurred anime characters, or blurred anime covers from 1500 anime.": { fr: "Jouez solo pour vous entraîner, ou jusqu'à 8 joueurs. Deux modes : personnages d'anime floutés, ou affiches d'anime floutées issues de 1500 animes.", es: "Juega en solitario para entrenar, o con hasta 8 jugadores. Dos modos: personajes de anime difuminados, o portadas de anime de 1500 animes." },
  ...
  "Tap a color chip to switch to that player's board — every card glows with their color. Tap a card to eliminate it (greyed like in 1v1 Detective Showdown — tap again to undo). Eliminations and guesses are per-board!": { fr: "Touchez un jeton de couleur pour passer au plateau de ce joueur — chaque carte brille de sa couleur. Touchez une carte pour l'éliminer (grisée comme en Detective Showdown 1v1 — retouchez pour annuler). Éliminations et accusations sont par plateau !", es: "Pulsa una ficha de color para cambiar al tablero de ese jugador — cada carta brilla con su color. Pulsa una carta para eliminarla (en gris como en Detective Showdown 1v1 — pulsa de nuevo para deshacer). ¡Las eliminaciones y acusaciones son por tablero!" },
  ...
  "How to play": { fr: "Comment jouer", es: "Cómo jugar" },
  "Your secret — tap to hide": { fr: "Votre secret — touchez pour cacher", es: "Tu secreto — toca para ocultar" },
  "Mystery — only YOU see this": { fr: "Mystère — seul VOUS le voyez", es: "Misterio — solo TÚ lo ves" },
  "You are a SHOGUN — wait for the clue…": { fr: "Vous êtes un SHOGUN — attendez l'indice…", es: "Eres un SHOGUN — espera la pista…" },
  "NINJA key — only you see every color": { fr: "Clé NINJA — seul vous voyez les couleurs", es: "Clave NINJA — solo tú ves los colores" },
  ...
  "Clue: ⚔ \"sword, 2\" — tap up to 2 cards!": { fr: "Indice : ⚔ « épée, 2 » — touchez jusqu'à 2 cartes !", es: "Pista: ⚔ \"espada, 2\" — ¡toca hasta 2 cartas!" },
  "Levi & Zoro live by the sword — that's your RED pair! A spot-on clue like this flips both at once.": { fr: "Levi & Zoro vivent par l'épée — voilà votre paire ROUGE ! Un indice pareil retourne les deux d'un coup.", es: "¡Levi y Zoro viven por la espada — ese es tu par ROJO! Una pista así voltea ambas a la vez." },
  ...
  "Detective Showdown": { fr: "Detective Showdown", es: "Detective Showdown" }, // PROTECT (game/role name — stays in English)
  "Wanted!": { fr: "Wanted!", es: "Wanted!" }, // PROTECT (game/role name — stays in English)
  "Detective Royale": { fr: "Detective Royale", es: "Detective Royale" }, // PROTECT (game/role name — stays in English)
  ...
  "Cold Case (2-6 players)": { fr: "Cold Case (2-6 joueurs)", es: "Cold Case (2-6 jugadores)" },
...
var I18N_PAT = {
  ...
  // ---- v37 additions (Cold Case, multiplayer 2-6) ----
