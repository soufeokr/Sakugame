...
var I18N = {
  ...
  "The hider scores every proposal: 0 = nothing alike… 90+ = so close it burns. An exact hit is found instantly — no scoring needed! Each seeker stops when THEY find it (or after 30 tries).": { fr: "Le cacheur note chaque proposition : 0 = rien à voir… 90+ = si proche que ça brûle. Un essai exact est trouvé instantanément — pas besoin de note ! Chaque chercheur s'arrête quand IL trouve (ou après 30 essais).", es: "El escondedor puntúa cada propuesta: 0 = nada parecido… 90+ = tan cerca que quema. ¡Un acierto exacto se detecta al instante — sin puntuación! Cada buscador para cuando ÉL lo encuentra (o tras 30 intentos)." },
