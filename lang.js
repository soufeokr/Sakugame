...
var I18N = {
  ...
  "1000 famous characters — no AniList needed": { fr: "1000 personnages célèbres — AniList non requis", es: "1000 personajes famosos — no hace falta AniList" },
  ...
  // ---- v32 additions (Guess Who — Hot & Cold) ----
  "Guess Who — Hot & Cold": { fr: "Guess Who — Hot & Cold", es: "Guess Who — Hot & Cold" }, // PROTECT (game/role name — stays in English)
  "You are the GUESSER": { fr: "Vous êtes le CHERCHEUR", es: "Eres el ADIVINADOR" },
  "You are the HIDER": { fr: "Vous êtes le CACHEUR", es: "Eres el ESCONDEDOR" },
  "Tiebreak!": { fr: "Manche décisive !", es: "¡Ronda de desempate!" },
  "Draw!": { fr: "Match nul !", es: "¡Empate!" },
  "Pick any character from the pool and hide it — your opponent will feel their way to it!": { fr: "Choisissez n'importe quel personnage du pool et cachez-le — votre adversaire devra le trouver à tâtons !", es: "¡Elige cualquier personaje del pool y escóndelo — tu rival tendrá que encontrarlo a tientas!" },
  ...
  "Your opponent guessed:": { fr: "Votre adversaire a proposé :", es: "Tu rival propuso:" },
  ...
  "Hot & Cold needs exactly 2 players!": { fr: "Hot & Cold nécessite exactement 2 joueurs !", es: "¡Hot & Cold necesita exactamente 2 jugadores!" },
  "Need 2 players to start!": { fr: "Il faut 2 joueurs pour commencer !", es: "¡Se necesitan 2 jugadores para empezar!" },
  "Leave the duel?": { fr: "Quitter le duel ?", es: "¿Abandonar el duelo?" },
  "Stay in the duel": { fr: "Rester dans le duel", es: "Quedarse en el duelo" },
  "A duel needs both players — leaving now gives your opponent the win by forfeit.": { fr: "Un duel nécessite les deux joueurs — partir maintenant offre la victoire par forfait à votre adversaire.", es: "Un duelo necesita a ambos jugadores — irte ahora le da la victoria por abandono a tu rival." },
  "The duel is over — everyone goes back to the lobby.": { fr: "Le duel est terminé — tout le monde retourne au salon.", es: "El duelo terminó — todos vuelven al lobby." },
  "Your opponent left the duel — you win by forfeit!": { fr: "Votre adversaire a quitté le duel — vous gagnez par forfait !", es: "Tu rival abandonó el duelo — ¡ganas por abandono!" },
  "2 players! One hides a character, the other names characters and after each guess gets a 0-100 closeness score. Find it in fewer guesses than your opponent!": { fr: "2 joueurs ! L'un cache un personnage, l'autre propose des personnages et reçoit après chaque essai une note de proximité de 0 à 100. Trouvez-le en moins d'essais que votre adversaire !", es: "¡2 jugadores! Uno esconde un personaje, el otro nombra personajes y tras cada intento recibe una puntuación de cercanía de 0 a 100. ¡Encuéntralo en menos intentos que tu rival!" },
  ...
  "found in 5 guesses": { fr: "trouvé en 5 essais", es: "lo encontró en 5 intentos" },
  "found in 7 guesses → You win!": { fr: "trouvé en 7 essais → Vous gagnez !", es: "lo encontró en 7 intentos → ¡Tú ganas!" },
};
...
var I18N_PAT = {
  ...
  dist_label:      { en: "Distribution: {v} from {a} / {r} from {b}", fr: "Répartition : {v} de {a} / {r} de {b}", es: "Reparto: {v} de {a} / {r} de {b}" },
  ...
  hc_track:        { en: "Track down the secret — this is guess <b>#{c}</b>! Every proposal gets a 0-100 score.", fr: "Trouvez le secret — ceci est la proposition <b>n°{c}</b> ! Chaque essai reçoit une note de 0 à 100.", es: "Encuentra el secreto — esta es la suposición <b>n.º {c}</b>. Cada intento recibe una puntuación de 0 a 100." },
  ...
  hc_wait_guess:   { en: "<b>{n}</b> is guessing — {c} guess(es) so far. Sit tight!", fr: "<b>{n}</b> cherche — {c} essai(s) pour l'instant. Patience !", es: "<b>{n}</b> está buscando — {c} intento(s) hasta ahora. ¡Paciencia!" },
  ...
  hc_tie:          { en: "Dead even at <b>{c}</b> guesses — <b>tiebreak round!</b> Roles swap one last time.", fr: "Égalité parfaite à <b>{c}</b> essais — <b>manche décisive !</b> Les rôles s'inversent une dernière fois.", es: "Empate total a <b>{c}</b> intentos — ¡<b>ronda de desempate!</b> Los roles se intercambian una última vez." },
  ...
  hc_win_you:      { en: "Fewer guesses — <b>you win the duel!</b>", fr: "Moins d'essais — <b>vous remportez le duel !</b>", es: "Menos intentos — ¡<b>ganas el duelo!</b>" },
  hc_win_them:     { en: "<b>{n}</b> wins the duel on fewer guesses!", fr: "<b>{n}</b> remporte le duel avec moins d'essais !", es: "¡<b>{n}</b> gana el duelo con menos intentos!" },
  hc_draw:         { en: "Dead even — <b>it's a draw!</b>", fr: "Égalité parfaite — <b>match nul !</b>", es: "Igualados — ¡<b>es un empate!</b>" },
