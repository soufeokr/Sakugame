...
var I18N = {
  ...
  "Everyone joins a team, then give the 🔑 to one Ninja per team. The host can move anyone or shuffle it all.": { fr: "Tout le monde rejoint une équipe, puis donne la 🔑 à un Ninja par équipe. L'hôte peut déplacer n'importe qui ou tout mélanger.", es: "Todos se unen a un equipo, luego da la 🔑 a un Ninja por equipo. El anfitrión puede mover a cualquiera o mezclarlo todo." },
